...
Lsky Pro V2.1 要求PHP >= 8.0.2，Ubuntu可以直接安装[^1]
...
{{<refers title="参考">}}
{{<refer desc="如何在Ubuntu中将PHP升级到8.0" url="https://zhuanlan.zhihu.com/p/402297155">}}
{{</refers>}}

[^1]: [如何在Ubuntu中将PHP升级到8.0](https://zhuanlan.zhihu.com/p/402297155)